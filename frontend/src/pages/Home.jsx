      ...
      <div className=" container max-w-[86rem] w-full mx-auto px-4 pb-2">
        ...
        <div className="pb-6 mb-6 border-b-2 border-[#ddd] " id="Services">
          ...
          <div className="flex justify-center items-center  gap-x-5 gap-y-8 lg:gap-y-0 flex-wrap md:flex-wrap lg:flex-nowrap lg:flex-row lg:justify-between lg:gap-x-8">
            <div className="group relative w-full shadow-lg bg-[#ffffff] rounded-2xl p-4 transition-all duration-500 max-md:max-w-md max-md:mx-auto md:w-2/5 md:h-72 xl:p-7 lg:w-[32%] hover:bg-[#7D7CEC]">
            ...
            <div className="group relative shadow-lg w-full bg-[#ffffff] rounded-2xl p-4 transition-all duration-500 max-md:max-w-md max-md:mx-auto md:w-2/5 md:h-72 xl:p-7 lg:w-[32%] hover:bg-[#7D7CEC]">
              <div className="bg-[#f6f6f6] shadow-lg rounded-full flex justify-center items-center mb-5 w-14 h-14 ">
      ...
      <div className="container mx-auto" id="Contact">
        <div className="max-w-[86rem] mx-auto px-4">
          <div className="grid lg:grid-cols-7 lg:gap-x-4 xl:gap-x-12  lg:items-center  ">
            <div className="lg:col-span-4 flex  h-full">
              <div className="mb-12 max-w-[570px] lg:mb-0 flex flex-col justify-center">
                <div className="w-full">
                  <span className="block  text-lg font-semibold text-[#7D7CEC]">
                    Contact Us
                  </span>
                  <h2 className="mb-3 text-xl font-semibold text-dark  sm:text-[40px]/[48px]">
                ...
                <div className="mb-6 flex w-full max-w-[370px] items-center gap-3">
                  <div className="bg-white flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded-full bg-primary/5 text-primary sm:h-[70px] sm:max-w-[70px]">
                    <svg
                      width="32"
                      height="32"
                      viewBox="0 0 32 32"
            ...
            <div className="lg:col-span-3 mt-10 lg:mt-0 py-10">
              <div className="relative rounded-lg bg-white  shadow-lg  px-8 py-10">
                <form onSubmit={(e) => e.preventDefault()}>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full rounded-lg border border-primary bg-[#0b0b43] py-2 text-white transition hover:bg-opacity-90 text-base"
                    >
                      Send Message
                    </button>
                  </div>
